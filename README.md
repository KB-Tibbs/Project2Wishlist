...
One challenge I’ve run into so far is how to allows the users input to pop up in a list after they submit their entry and I’m trying to get the word “submit” to appear on the submit button. Also, I am still trying to format the layout of the EditText & TextView boxes.
